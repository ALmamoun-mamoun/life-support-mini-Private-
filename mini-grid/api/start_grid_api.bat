@echo off
setlocal
set "LS_MINI_DB_PATH=E:\\life-support-mini-grid\db\mini.db"
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "Start-Process -WindowStyle Minimized -FilePath $node -ArgumentList 'server.js' -WorkingDirectory 'E:\\life-support-mini-grid\api' -RedirectStandardOutput 'E:\\life-support-mini-grid\api\mini_api.out.log' -RedirectStandardError 'E:\\life-support-mini-grid\api\mini_api.err.log'"
